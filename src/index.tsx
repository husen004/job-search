    ...
    <BrowserRouter>
      <div className="container mx-auto">
        <header className="py-4 mb-4 border-b">
          <h1 className="text-2xl font-bold text-blue-600">Job Search App</h1>
          <nav className="mt-2">
            <ul className="flex flex-wrap space-x-4">
              ...
              <li><Link to="/advanced" className="text-blue-500 hover:underline">Advanced Posts</Link></li>
              <li><Link to="/manage" className="text-blue-500 hover:underline">Manage Posts</Link></li>
