...
/**
 * Redux action tracking middleware
 * Logs all redux actions for debugging
 */
export const actionLogger: Middleware = () => (next) => (action) => {
  // Skip logging certain high-frequency actions
